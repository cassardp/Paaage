      ...
      {(onFlip: () => void) => (
        <div className="h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            <WeatherIcon className={`w-10 h-10 ${isDark ? 'text-neutral-200' : 'text-neutral-700'}`} strokeWidth={1.5} />
            <div>
              <p className={`text-2xl font-medium ${isDark ? 'text-neutral-200' : 'text-neutral-700'}`}>{weather.temperature}°C</p>
              <p
                onClick={onFlip}
