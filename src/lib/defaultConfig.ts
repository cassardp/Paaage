...
export const DEFAULT_CONFIG: Config = {
  ...
  blocks: [
    ...
    { id: 'tj5g1v4', type: 'station', name: 'Radio Classique', streamUrl: 'https://str0.creacast.com/classique1', layout: { x: 76, y: 48, w: 16, h: 4 } },
    { id: 'xlvm0hv', type: 'news', layout: { x: 76, y: 18, w: 16, h: 23 } },
    { id: 'e50vsl2', type: 'search', layout: { x: 27, y: 22, w: 40, h: 4 } },
    { id: '5mbmg3e', type: 'clock', city: 'San Francisco', timezone: 'America/Los_Angeles', layout: { x: 2, y: 8, w: 9, h: 6 } },
    { id: '531hyko', type: 'station', name: 'FIP', streamUrl: 'https://icecast.radiofrance.fr/fip-midfi.mp3', layout: { x: 76, y: 43, w: 16, h: 4 } },
    { id: 'yrnxsch', type: 'note', content: 'Bienvenue sur Paaage.app !!\n\nVous pouvez ajouter, déplacer, supprimer des blocs, et créer votre propre page de démarrage. ', layout: { x: 36, y: 7, w: 20, h: 9 } },
    { id: 'tss2dwv', type: 'stock', symbol: 'AAPL', layout: { x: 23, y: 31, w: 14, h: 5 } },
    ...
    { id: 'fohf9ph', type: 'note', content: 'Humm... c\'est très intéressant ! \n\nhttps://www.youtube.com/watch?v=xvFZjo5PgG0', layout: { x: 51, y: 35, w: 20, h: 8 } },
    {
      ...
      items: [
        ...
        { id: '2qqgllw', text: 'Sauvegarde pendant l\'écriture des notes', done: false },
        { id: 'ytbo5j7', text: 'Undo (menu settings)', done: true },
      ],
      layout: { x: 2, y: 16, w: 19, h: 35 },
    },
    { id: '1t6dp32', type: 'note', content: '', layout: { x: 17, y: 38, w: 20, h: 8 } },
  ],
};
